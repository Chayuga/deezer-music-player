                    ...
                    <div className="flex flex-wrap -mx-1 lg:-mx-4">
                        ...
                        <div className="my-5 px-1 w-full md:w-1/2 lg:my-12 lg:px-4 lg:w-1/3">
                            ...
                            <article className="overflow-hidden rounded-lg shadow-lg w-[400px] h-full">
                                <header
                                    className="flex items-center justify-between leading-tight p-2 md:p-4 bg-gray-200">
                                ...
                                <footer
                                    className="flex items-center justify-between leading-none p-2 md:p-4 bg-gray-900">
                                    <a
